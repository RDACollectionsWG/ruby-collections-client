...
module CollectionsClient
  ...
  class CollectionItemMappingMetadata
    # The ole that applies to this item. Only available if the collection supportsRoles per its capabilities. A Controlled Vocabulary should be used.
    attr_accessor :role

    # position of the item in the collection. Only available if the Collection isOrdered per its capabilities.
    attr_accessor :index
