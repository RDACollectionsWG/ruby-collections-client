...
module CollectionsClient
  # A resultset containing a potentially iterable list of Member Items. This is the schema for the response to any request which retrieves collection members.
  class MemberResultSet
    # list of Member Items returned in responses to a query
    attr_accessor :contents

    # If the service supports pagination, and the resultset is paginated, this will be cursor which can be used to retrieve the next page in the results.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'prev_cursor')
    ...
    def hash
      [contents, next_cursor, prev_cursor].hash
    end
